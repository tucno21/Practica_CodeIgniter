        ...
        <div class="row mt">
            <div class="col-lg-10">
                <div class="form-panel">
                    ...
                    <form method="POST" class="form-horizontal style-form" action="<?= base_url(route_to('categoria_update')) ?>">
                        <?= csrf_field() ?>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">Nombre</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?php if ($validation->getError('name')) : ?>is-invalid<?php endif ?>" name="name" value="<?= old('name') ?? $category->name ?>" placeholder="Nombre" />
                            </div>
